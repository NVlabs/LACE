...
from afhq_data import AFHQCatLatentDataset, get_att_name_list, get_n_classes_list
...
def get_data(args):
    ...
    full_train = AFHQCatLatentDataset(args.root_path, args.att_names, train=True, threshold=args.threshold)
    ...
    dset_train = DataSubset(
        AFHQCatLatentDataset(args.root_path, args.att_names, train=True, threshold=args.threshold),
        inds=train_inds)
    ...
    dset_test = AFHQCatLatentDataset(args.root_path, args.att_names, train=False, threshold=args.threshold)
...
def main(args):
    ...
    save_path = os.path.join(args.save_dir, f'{args.att_names}_th{args.threshold}_bs{args.batch_size}_'
