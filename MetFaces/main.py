...
import utils
from metfaces_data import get_att_name_list
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", default="metfaces_latent_train", type=str,
                        choices=["metfaces_latent_train", "metfaces_latent_test"],
