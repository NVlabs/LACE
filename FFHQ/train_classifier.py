...
from ffhq_data import FFHQLatentDataset, get_att_name_list, get_n_classes_list
...
def get_data(args):
    ...
    full_train = FFHQLatentDataset(args.root_path, args.att_names, train=True)
    ...
    dset_train = DataSubset(
        FFHQLatentDataset(args.root_path, args.att_names, train=True),
        inds=train_inds)
    ...
    dset_test = FFHQLatentDataset(args.root_path, args.att_names, train=False)
